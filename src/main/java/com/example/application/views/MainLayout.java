...
import com.example.application.views.compareversion.CompareVersionView;
 ...
 */
@PWA(name = "Version Comparator App", shortName = "Version Comparator App", enableInstallPrompt = false)
@Theme(themeFolder = "versioncomparatorapp", variant = Lumo.DARK)
@PageTitle("Main")
public class MainLayout extends AppLayout {
    ...
    private Component createDrawerContent(Tabs menu) {
        ...
        logoLayout.add(new Image("images/logo.png", "Version Comparator App logo"));
        logoLayout.add(new H1("Version Comparator App"));
    ...
    private List<Tab> createMenuItems() {
        MenuItemInfo[] menuItems = new MenuItemInfo[]{ //
                new MenuItemInfo("Compare Version", "la la-user", CompareVersionView.class), //
